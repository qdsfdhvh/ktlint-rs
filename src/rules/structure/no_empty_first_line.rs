...
#[cfg(test)] mod tests { use super::*; use crate::parser::KotlinParser;
    fn c(s:&str)->Vec<Violation>{let mut p=KotlinParser::new();NoEmptyFirstLineInClassBody.check(&p.parse(s),s)}
