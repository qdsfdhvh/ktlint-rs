...
[![Rules](https://badgen.net/badge/rules/252/blue)](https://github.com/qdsfdhvh/ktlint-rs)
...
- **252 unique registry rules** (104 standard/ktlint-oriented + 148 detekt) — zero JVM dependency
...
|---|---:|---|
| ktlint-rs standard/ktlint-oriented IDs | 104 | Includes compatibility helpers and rs-only IDs |
| Enabled ktlint-compatible registry IDs | 89 | Unique IDs used by `--ruleset ktlint` |
| ktlint 1.8.0 standard oracle | 101 | Runtime inventory from the pinned JVM oracle |
| Oracle rules matched to Rust owners | 88 | Registration only; behavior remains unverified until differential fixtures pass |
| Oracle rules currently missing | 13 | Implementation backlog |
| Detekt registry IDs | 148 | Outside the Kataris Spotless replacement scope |
| **Unique registry total** | **252** | **104 standard-oriented + 148 detekt** |
