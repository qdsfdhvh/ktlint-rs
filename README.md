...
[![Rules](https://badgen.net/badge/rules/254/blue)](https://github.com/qdsfdhvh/ktlint-rs)
...
- **254 unique registry rules** (106 standard/ktlint-oriented + 148 detekt) — zero JVM dependency
...
|---|---:|---|
| ktlint-rs standard/ktlint-oriented IDs | 106 | Includes compatibility helpers and rs-only IDs |
| Enabled ktlint-compatible registry IDs | 91 | Unique IDs used by `--ruleset ktlint` |
| ktlint 1.8.0 standard oracle | 101 | Runtime inventory from the pinned JVM oracle |
| Oracle rules matched to Rust owners | 90 | Registration only; behavior remains unverified until differential fixtures pass |
| Oracle rules currently missing | 11 | Implementation backlog |
| Detekt registry IDs | 148 | Outside the Kataris Spotless replacement scope |
| **Unique registry total** | **254** | **106 standard-oriented + 148 detekt** |
